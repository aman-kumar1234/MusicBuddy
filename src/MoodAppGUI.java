...
public class MoodAppGUI extends JFrame {
    ...
    public MoodAppGUI(String username) {
        ...
        try {
            songDAO = new SongDAO();
            setTitle("MusicBuddy - Welcome " + username);
            setSize(600, 400);
            ...
            youtubeBtn.setBackground(Color.RED);
            ...
            offlineBtn.setBackground(new Color(0, 123, 255));
    ...
    private void selectMood(JButton btn, String mood) {
        ...
        if (selectedMoodButton != null) {
            selectedMoodButton.setBackground(new Color(240, 248, 255));
            selectedMoodButton.setForeground(Color.BLACK);
        }
    ...
    private void createPlaylistPanel() {
        ...
        selectFolderBtn.setBackground(new Color(0, 123, 255));
    ...
    private void createControlPanel() {
        ...
        for (Component btn : buttons) {
            ((JButton)btn).setBackground(new Color(240, 240, 240));
            ((JButton)btn).setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200)));
        }
        ...
        controlPanel.add(nowPlayingLabel);
        controlPanel.add(Box.createVerticalStrut(10));
